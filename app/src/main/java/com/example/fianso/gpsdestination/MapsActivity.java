...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, DirectionFinderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment.getMapAsync(this); // la méthode qui démarre le service de la carte map
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //.icon(BitmapDescriptorFactory.fromResource(R.drawable.img_548403))
        );
        ...
        mMap.setMyLocationEnabled(true); // afficher l'emplacement actuel de l'utilisateur
    }
